...
public class BookAcitivty extends AppCompatActivity {
    ...
    private BookTask mAuthTask;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_book_acitivty);
